...
export function CommunicationAnalyticsCharts({
  filters,
}: CommunicationAnalyticsChartsProps) {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        setLoading(true);
        const response =
          await mockAnalyticsService.getCommunicationAnalytics(filters);
    ...
    return (
      <Card withBorder radius="md" p="lg">
        <Text c="dimmed" ta="center">
          Failed to load communication analytics data
        </Text>
      </Card>
    );
  }
  ...
  return (
    <SimpleGrid cols={{ base: 1, lg: 2 }} spacing="md">
      ...
      <Card withBorder radius="md" p="lg">
        ...
        <Progress value={data.deliveryRate} size="sm" color="green" mb="md" />
        ...
        <Group justify="space-between" mb="xs">
          ...
          <Badge
            size="sm"
            variant="light"
            color={data.openRate > 25 ? 'green' : 'orange'}
          >
        ...
        <Progress
          ...
          size="sm"
          color={
            data.openRate > 25 ? 'green' : data.openRate > 15 ? 'yellow' : 'red'
          }
          mb="md"
        />
        ...
        <Group justify="space-between" mb="xs">
          ...
          <Badge
            size="sm"
            variant="light"
            color={data.clickRate > 5 ? 'green' : 'orange'}
          >
        ...
        <Progress
          ...
          size="sm"
          color={
            data.clickRate > 5 ? 'green' : data.clickRate > 2 ? 'yellow' : 'red'
          }
        />
      </Card>
          ...
          <div style={{ textAlign: 'center' }}>
            <RingProgress
              ...
              sections={[
                {
                  value: data.openRate,
                  color: data.openRate > 25 ? 'blue' : 'orange',
                },
              ]}
              label={
                <Text ta="center" fw={700} size="sm">
          ...
          <div style={{ textAlign: 'center' }}>
            <RingProgress
              ...
              sections={[
                {
                  value: data.clickRate,
                  color: data.clickRate > 5 ? 'teal' : 'red',
                },
              ]}
              label={
                <Text ta="center" fw={700} size="sm">
      ...
      <Card withBorder radius="md" p="lg">
        ...
        <BarChart
          ...
          dataKey="type"
          series={[
            { name: 'openRate', color: 'violet.6', label: 'Open Rate (%)' },
          ]}
          tickLine="y"
          gridAxis="y"
          withTooltip
