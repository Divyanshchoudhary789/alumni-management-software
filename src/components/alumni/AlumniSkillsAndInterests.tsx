...
export function AlumniSkillsAndInterests({
  ...
  const displayedInterests = getDisplayItems(
    filteredInterests,
    showAllInterests
  );
        ...
        {alumni.interests.length > 0 && (
          <div>
            ...
            <Group gap="xs">
              ...
              {!showAllInterests &&
                alumni.interests.length > (maxDisplay || 5) && (
                  <Button
                    variant="subtle"
                    size="xs"
  ...
  return (
    <Stack gap="md">
      {/* Search */}
      {showSearch &&
        (alumni.skills.length > 5 || alumni.interests.length > 5) && (
          <Input
          ...
          <Stack gap="sm">
            ...
            {displayedSkills.length > 0 ? (
              <Group gap="xs">
                {displayedSkills.map(skill => (
                  <SkillBadge
                    ...
                    onRemove={() => {
                      ...
                      const updatedSkills = alumni.skills.filter(
                        s => s !== skill
                      );
                ...
                {!showAllSkills &&
                  alumni.skills.length > displayedSkills.length && (
                    <Button
                      variant="subtle"
                      size="xs"
          ...
          <Stack gap="sm">
            ...
            {displayedInterests.length > 0 ? (
              <Group gap="xs">
                {displayedInterests.map(interest => (
                  <SkillBadge
                    ...
                    onRemove={() => {
                      ...
                      const updatedInterests = alumni.interests.filter(
                        i => i !== interest
                      );
                ...
                {!showAllInterests &&
                  alumni.interests.length > displayedInterests.length && (
                    <Button
                      variant="subtle"
                      size="xs"
                      rightSection={<IconChevronDown size={14} />}
                      onClick={() => setShowAllInterests(true)}
                    >
                      Show {alumni.interests.length - displayedInterests.length}{' '}
                      more
                    </Button>
                  )}
                {showAllInterests &&
                  alumni.interests.length > (maxDisplay || 10) && (
                    <Button
                      variant="subtle"
                      size="xs"
                      rightSection={<IconChevronUp size={14} />}
          ...
          <Center>
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                Skills and interests help others understand your expertise and
                passions
              </Text>
              {editable && (
                <Button
      ...
      >
        <Stack gap="md">
          <Text size="sm" c="dimmed">
            Add or remove skills and interests to help others understand your
